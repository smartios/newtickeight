...
#define FSCalendarStandardTitleTextColor   FSColorRGBA(0,0,0 ,1.0)
#define FSCalendarStandardWeekDayTitleTextColor   FSColorRGBA(255,255,255 ,1.0)
#define FSCalendarStandardEventDotColor    FSColorRGBA(31,119,219,0.75)

//vaibhav
#define FSCalendarStandardLineColor             FSColorRGBA(231,234,239,0.75)
#define FSCalendarStandardSeparatorColor        [[UIColor lightGrayColor] colorWithAlphaComponent:0.30]
