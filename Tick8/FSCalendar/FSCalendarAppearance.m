...
- (instancetype)init
{
    ...
    if (self) {
        ...
        //vaibhav
        _weekdayTextColor = FSCalendarStandardWeekDayTitleTextColor;
        ...
        _backgroundColors[@(FSCalendarCellStateSelected)]    = [UIColor clearColor];//FSCalendarStandardSelectionColor;
