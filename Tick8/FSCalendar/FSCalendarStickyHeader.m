...
- (void)layoutSubviews
{
    ...
    _bottomBorder.frame = CGRectMake(20, _contentView.fs_height-weekdayHeight-weekdayMargin*2, _contentView.fs_width-40, 1.0);
    
    
    _titleLabel.frame = CGRectMake(0, _bottomBorder.fs_bottom-titleHeight-weekdayMargin - 5, titleWidth,titleHeight);
