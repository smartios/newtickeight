...
- (void)layoutSubviews
{
    ...
    if (_subtitle) {
        ...
        _titleLabel.frame = CGRectMake(
                                       ...
                                       (self.contentView.fs_height*5.0/6.0-height)*0.5+self.preferredTitleOffset.y+4,
        ...
        _subtitleLabel.frame = CGRectMake(
                                          ...
                                          (_titleLabel.fs_bottom-self.preferredTitleOffset.y) - (_titleLabel.fs_height-_titleLabel.font.pointSize)+self.preferredSubtitleOffset.y + 12,
                                          self.contentView.fs_width,
                                          subtitleHeight
                                          );
    } else {
